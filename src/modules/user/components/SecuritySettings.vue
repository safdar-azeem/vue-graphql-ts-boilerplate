...
const isEnabled = computed(
	() => result.value?.me?.mfaSettings?.isEnabled ?? false,
)
	...
	<div class="p-6 bg-white rounded-lg border shadow-sm">
		...
		<div
			...
			<p class="text-sm text-gray-600">
				Protect your account by enabling two-factor authentication. You
				can use an authenticator app (like Google Authenticator) or
				email to receive verification codes.
			</p>

			<div
				class="flex flex-col sm:flex-row gap-4 items-center bg-gray-50 p-4 rounded-lg">
				<div class="w-full sm:w-auto">
					...
					<select
						...
						<option :value="TwoFactorMethod.Authenticator">
							Authenticator App (Recommended)
						</option>
						<option :value="TwoFactorMethod.Email">
							Email Verification
						</option>
					</select>
				</div>
				<Button
					...
					:loading="initLoading"
					class="w-full sm:w-auto sm:mt-5"
					>Set Up 2FA</Button
				>
			</div>
			<div
		...
		<div
			...
			<div
				...
				<div
					v-if="selectedMethod === TwoFactorMethod.Authenticator"
					class="space-y-6">
					<div
					...
					<div class="flex flex-col items-center gap-4">
						<div
							v-if="qrCodeUrl"
							class="bg-white p-2 border rounded-lg shadow-sm">
							<img
								:src="qrCodeUrl"
								alt="QR Code"
				...
				<div
					...
					<div>
						...
						<p>
							...
							address. It may take a minute to arrive.
						</p>
					</div>
				</div>
