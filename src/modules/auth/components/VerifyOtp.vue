...
import { useVerify2FaMutation } from '@/graphql'
import { OTPInput, Button, showToast } from 'vlite3'
...
<template>
  <div class="space-y-6 text-center">
    ...
    <Button class="w-full" :loading="loading" :disabled="otpCode.length < 6" @click="handleVerify">
      Verify & Login
    </Button>

    <div class="text-sm">
      <router-link :to="ROUTES.AUTH.LOGIN" class="text-gray-500 hover:text-gray-900"
