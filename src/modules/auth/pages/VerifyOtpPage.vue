...
<template>
  <div class="space-y-6 text-center">
    ...
    <div class="flex justify-center py-4">
      <OTPInput v-model="otpCode" :length="6" variant="outline" size="lg" attached @complete="handleVerify" />
    </div>
    ...
    <div class="text-sm">
      <router-link to="/auth/login" class="text-gray-500 hover:text-gray-900">Back to Login</router-link>
    </div>
  </div>
</template>
