...
The stepper strip is a **`dir="ltr"` island** (− on the left, + on the right) with logical radii/borders inside that island. The number field’s placeholder and text direction follow page `dir` so localized placeholders still mirror under RTL.
